...
public class ExercicioProposto {
	...
	public static void main(String[] args) {
			...
			//declarei o caminho at� o caminho do arquivo fonte
		 	String path = "C:\\\\temp\\\\in.txt";
		 	//String para o caminho do arquivo pronto
			String strPath = "c:\\temp\\out";
			//criei uma lista de produtos e adicionei a classe arraylist para as fun��es
			List <Product> product = new ArrayList<>();
			//Vetores auxiliares que um � do arquivo fonte e outro dividi essa string em partes
			String[] lineFile = new String[6];
			String[][] outFile = new String[6][3];
			int n = 0; 
			//Criando o arquivo out, quando for criar s� declarar o arquivo depois de new File
			...
			for(String s : lineFile) {
				outFile[n] = s.split(",");
				//depois de dividido a string, � adicionado cada campo atribuindo a sua variavel
				String name = outFile[n][0];
				//sempre lembrando de transformar ela no tipo de variavel certa, j� que ela � uma string
			...
			//nele voc� declara o arquivo que vai ser criado e o tipo quando clarado
			try(BufferedWriter bw = new BufferedWriter(new FileWriter(strPath + "\\summary.csv"));){
				
				//esse for, concatena o objeto com os atributos do produto que est� na lista
